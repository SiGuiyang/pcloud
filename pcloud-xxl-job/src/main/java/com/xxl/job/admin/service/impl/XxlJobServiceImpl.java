...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    @Override
    public Map<String, Object> pageList(int page, int pageSize, int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author) {

        // page list
        List<XxlJobInfo> list = xxlJobInfoDao.pageList((page - 1) * pageSize, pageSize, jobGroup, triggerStatus, jobDesc, executorHandler, author);
